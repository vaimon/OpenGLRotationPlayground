...
//        val affineMatrix = ru.mmcs.openglrotationplayground.utils.Matrix(3,3, listOf(
//            cos(angle), 0f, sin(angle),
//            0f, 1f, 0f,
//            -sin(angle), 0f, cos(angle)))
//        val positionVector = ru.mmcs.openglrotationplayground.utils.Matrix(1, 3, listOf(x, y, z)) * affineMatrix
...
//            0f, 1f, 0f,
//            -sin(angle), 0f, cos(angle)))
//        val positionVector = ru.mmcs.openglrotationplayground.utils.Matrix(1, 3, listOf(x - lineCenter.x,  - lineCenter.y, z - lineCenter.z)) * affineMatrix
